...
#include "ui_testimagencomputador.h"

TestImagenComputador::TestImagenComputador(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::TestImagenComputador)
{
    ui->setupUi(this);
...
TestImagenComputador::~TestImagenComputador()
{
    delete ui;
}

void TestImagenComputador::dibujar(QByteArray buff)
{
...
void TestImagenComputador::onError(QString msg)
{
...
void TestImagenComputador::onConectado(QString msg)
{
    ui->statusBar->showMessage(msg);
}

void TestImagenComputador::onRecibido(QByteArray buff)
{
    //Cabecera    
...
void TestImagenComputador::on_btnCapturar_clicked()
{
...
void TestImagenComputador::on_btnCerrar_clicked()
{
